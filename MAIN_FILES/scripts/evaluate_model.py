...
def figura_comparacion(df_resultados, ruta_salida="../resultados/figuras/figura_comparacion.png"):
    """
...
def figura_variabilidad(df_resultados, ruta_salida="../resultados/figuras/figura_variabilidad.png"):
    """
...
def figura_evolucion_anual(df_resultados, ruta_salida="../resultados/figuras/figura_evolucion_anual.png"):
    """
    ...
    for est in estrategias_clave:
        ...
        if sub.empty:
            continue
        ax.plot(sub['año'].to_numpy(), sub['beneficio_neto_eur'].to_numpy(),
...
if __name__ == "__main__":
    ...
    # ── 6. Exportar CSVs ──────────────────────────────────
    df_resultados.to_csv("../resultados/resultados_evaluacion.csv", index=False, sep=";", decimal=",")
    df_resumen.to_csv("../resultados/resumen_evaluacion.csv", sep=";", decimal=",")
    print(f"\n  CSV guardados: '../resultados/resultados_evaluacion.csv', '../resultados/resumen_evaluacion.csv'")
